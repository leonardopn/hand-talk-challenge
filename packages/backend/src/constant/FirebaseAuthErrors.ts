export const firebaseMappedAuthErrors = {
	...
	"auth/missing-identifier": "Um identificador uid é necessário para a operação atual.",
...
export type FirebaseAuthErrorsCode = keyof typeof firebaseMappedAuthErrors | (string & {});
